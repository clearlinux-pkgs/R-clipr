...
Version  : 0.8.0
Release  : 37
URL      : https://cran.r-project.org/src/contrib/clipr_0.8.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/clipr_0.8.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645551525
